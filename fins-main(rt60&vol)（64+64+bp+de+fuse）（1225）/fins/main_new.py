...
def main(args):
    # load config
    config_path = "/home/cxw/GAN/fins-main(rt60&vol)（64+64+bp+de+fuse）/fins/config.yaml"
    ...
    csv_path = ("/home/cxw/GAN/fins-main(rt60&vol)（64+64+bp+de+fuse）/fins/read(BP).csv")  # CSV 文件路径
